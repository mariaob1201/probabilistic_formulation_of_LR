# In this example, we begin with the simplest Generalized Linear Model (GLM) – linear regression.
#
# From a frequentist perspective, linear regression is typically expressed as:
# Y = X * B + e
# where:
